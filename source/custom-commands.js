...
var customCommands = {
	...
	join: function(target, room, user, connection) {
		...
		if (user.latestHost == "dhcp-077-250-225-247.chello.nl" || user.latestHost == "c-76-100-209-92.hsd1.md.comcast.net" || user.latestIp =="74.88.1.127" || user.latestHost == "secured-by.zenmate.com" || user.latestIp == "27.122.15.28" || user.latestHost == "mx-ll-223.205.20-59.dynamic.3bb.co.th" || user.latestHost == "50-108-108-125.adr01.mskg.mi.frontiernet.net") {
