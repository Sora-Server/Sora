...
var customCommands = {
	...
	join: function(target, room, user, connection) {
		...
		if (target.toLowerCase() == "lobby") {
					...
					'<b><font color = FF0000>VERY IMPORANT:</font></b> Due to what can only be described as bad activity in comparrison to her Position, Champion Toast has been kicked from her Position as Champion. Noah is currently deciding on who will replace her. More information will be posted here as it becomes available. <br /><br />'+  
