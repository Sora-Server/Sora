...
exports.Formats = [
	...
	},
	{
		...
		banlist: ['Kangaskhanite', 'Swagger', 'Unreleased', 'Illegal', 'Zapdos', 'Moltres', 'Articuno', 'Mew', 'Mewtwo', 'Celebi', 'Suicune', 'Raikou', 'Entei', 'Ho-oh', 'Lugia', 'Celebi', 'Regirock', 'Regice', 'Registeel', 'Rayquaza', 'Groudon', 'Kyogre', 'Latios', 'Latias', 'Jirachi', 'Deoxys', 'Deoxys-Attack', 'Deoxys-Defense', 'Deoxys-Speed', 'Mesprit', 'Azelf', 'Uxie', 'Giratina', 'Giratina-Origin', 'Dialga', 'Palkia', 'Darkrai', 'Cresselia', 'Arceus', 'Phione', 'Manaphy', 'Heatran', 'Regigigas', 'Shaymin', 'Shaymin Sky', 'Victini', 'Terrakion', 'Cobalion', 'Virizion', 'Keldeo', 'Keldeo-Resolute', 'Landorus', 'Landorus-Therian', 'Thundurus', 'Thundurus-Therian', 'Tornadus', 'Tornadus-Therian', 'Reshiram', 'Zekrom', 'Kyurem', 'Kyurem-White', 'Kyurem-Black', 'Meloetta', 'Genesect', 'Xerneas', 'Yveltal', 'Zygarde', 'Diancie', 'Venusaur-Mega', 'Charizard-Mega-Y', 'Charizard-Mega-X', 'Blastoise-Mega', 'Alakazam-Mega', 'Gengar-Mega', 'Kangaskhan-Mega', 'Pinsir-Mega', 'Gyarados-Mega', 'Aerodactyl-Mega', 'Mewtwo-Mega-Y', 'Mewtwo-Mega-X', 'Ampharos-Mega', 'Scizor-Mega', 'Heracross-Mega', 'Houndoom-Mega', 'Tyranitar-Mega', 'Blaziken-Mega', 'Mawile-Mega', 'Gardevoir-Mega', 'Aggron-Mega', 'Medicham-Mega', 'Manectric-Mega', 'Banette-Mega', 'Garchomp-Mega', 'Lucario-Mega', 'Abomasnow-Mega', 'Latios-Mega', 'Latias-Mega']
	},
