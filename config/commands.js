	...
	help: function (target, room, user) {
		...
		if (!target) {
			...
			if (user.group !== Config.groups.default[roomType]) {
				...
				this.sendReply("LEADER COMMANDS: /promote, /demote, /forcewin, /forcetie, /declare");this.sendReply("For details on all moderator commands, use /help " + Users.getGroupsThatCan('staff', room)[0]);
			}
